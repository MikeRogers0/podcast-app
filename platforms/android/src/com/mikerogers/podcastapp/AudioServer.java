...
// Baed upon https://raw.github.com/NanoHttpd/nanohttpd/master/webserver/src/main/java/fi/iki/elonen/SimpleWebServer.java 
...
public class AudioServer extends NanoHTTPD {
    ...
    public AudioServer(String host, int port, File wwwroot) {
        super(host, port);
